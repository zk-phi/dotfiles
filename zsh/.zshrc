...
export PATH="/usr/local/share/git-core/contrib/diff-highlight:$HOME/Documents/git-submodule-update-checker:$HOME/perl5/bin:$HOME/.ndenv/bin:$HOME/.plenv/bin:$HOME/go/bin:$HOME/.nimble/bin:$PATH"
