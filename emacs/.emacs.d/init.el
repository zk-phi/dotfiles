...
(defmacro my-elemental-theme-apply-colors
  ...
  (let* ((mode (if (string< bg-base fg-base) 'dark 'light))
         (bright-bg      (my-blend-colors bg-base (if (eq mode 'dark) "#fff" "#777") 7))
         (brighter-bg    (my-blend-colors bg-base (if (eq mode 'dark) "#fff" "#777") 14))
         (highlight-bg-1 (my-blend-colors bg-base (if (eq mode 'dark) "#fff" "#777") 25))
